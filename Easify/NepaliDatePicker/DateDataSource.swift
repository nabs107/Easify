...
class DateDataSource {
    ...
    static var startingEnglishYear = 1944
    static var startingEnglishMonth = 01
    static var startingEnglishDay = 01
    
    static var startingNepaliYear = 2000
    static var startingNepaliMonth = 09
    static var startingNepaliDay = 17
    
    public static func getSource() -> [Int: [Int]] {
        return [2000: [0, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
    ...
    public static func getStartingWeekDayOfMonth() -> [Int: [Int]] {
        return [
